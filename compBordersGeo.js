...
const scale = process.argv[3] && parseInt(process.argv[3]);
if (scale) merc = merc.scale(scale);

// The properties that we will add to the box
const properties = {
  lienchiang: { BORDERLEVEL: 'COUNTY',
  'NAME':	'連江縣',
  'ID':	'Z',
  'CODE':	'09007',
  'ENG':	'Lienchiang County',
 },
  penghu: { BORDERLEVEL: 'COUNTY',
  'NAME':	'澎湖縣',
  'ID':	'X',
  'CODE':	'10016',
  'ENG':	'Penghu County',
 },
  kinmen: { BORDERLEVEL: 'COUNTY',
  'NAME':	'金門縣',
  'ID':	'W',
  'CODE':	'09020',
  'ENG':	'Kinmen County'
 },
  wuqiu: {BORDERLEVEL: 'TOWN',
  NAME:	'烏坵鄉',
  ID:	'W06',
  'CODE':	'09020060',
  ENG:	'Wuqiu Township' },
