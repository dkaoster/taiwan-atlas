...
svgexport img/villages.svg img/villages.png 2x "path {stroke-width: 0.5px;}"
...
svgexport img/counties.svg img/counties.png 2x "path {stroke-width: 0.5px;}"

topo2geo nation=- < villages-mercator-10t.json | geo2svg -o img/nation.svg -w 450 -h 600
svgexport img/nation.svg img/nation.png 2x "path {stroke-width: 0.5px;}"
